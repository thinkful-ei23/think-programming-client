    ...
    <div className="instructions">
      ...
      <div className="instructions-content">
        ...
        <ul>
          ...
          <li>If your lucky another player has already joined and sat as well.  If not we wait for an opponent to show up... (text your friends the Think Programming Link)</li>
          <li>When two players have pressed sit the race begins!</li>
        </ul>
        <h3>Game Play...</h3>
        <ul>
          ...
          <li>At this point we will run tests on your solution and if successfull you will be prompted to the next question.</li>
